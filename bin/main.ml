...
let draw_dolm renderer font small_font =
    ...
    ignore (Sdl.set_render_draw_color renderer 255 255 255 255);
    draw_filled_rect renderer preview_x reset_y (btn_w * 2 + btn_gap) btn_h;
    draw_text renderer small_font "RESET" (preview_x + (btn_w * 2 + btn_gap) / 2) (reset_y + btn_h / 2) 0 0 0;
    (* grid state *)
    ignore (Sdl.set_render_draw_color renderer 255 255 255 255);
